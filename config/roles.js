...
roleRights.set(roles[0], ["manageProfile", 'manageReview', 'manageCart', "viewPhone", "getGroupBuy",
  'manageWishList', 'manageAddress', "getOrders", "managePayment", "manageVideo", "follow", "shippmentStatus",
...
roleRights.set(roles[2], [
  ...
  "manageOrders", "getOrders", "manageSellerDetail", "manageOrderStatus", "manageVideo", "manageSellerConfidentialDetail", "print", "notification"
...
roleRights.set(roles[3], [
  ...
  "manageTranslation", "manageProducts"
]);
